...
public class SecurityConfig {
        ...
        http.cors(Customizer.withDefaults())
            .csrf(csrf -> csrf.disable())
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/**").hasAnyAuthority("SCOPE_blueprints.read", "SCOPE_blueprints.write")
                        .requestMatchers(HttpMethod.POST, "/api/**").hasAuthority("SCOPE_blueprints.create")
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        source.registerCorsConfiguration("/api/**", config); // aplica a tus endpoints /api/**
        return source;
    }
